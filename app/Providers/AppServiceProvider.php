...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Admin luôn pass (defined in User::hasPositionCapability).
        // HR/Employee phải có chức vụ với capability tương ứng.
        foreach (PositionCapability::all() as $capability) {
