...
$replacements = [
    // Double encoded in Index.vue (UTF-8 -> ISO-8859-1 -> UTF-8 -> ISO-8859-1 -> UTF-8)
    'DÃ¡Â»Â± ÃƒÂ¡n' => 'Dự án',
    ...
    'Dá»± Ã¡n Ä‘ang bá»‹ khÃ³a, khÃ´ng thá»ƒ thÃªm Ä‘º§u viá»‡c.' => 'Dự án đang bị khóa, không thể thêm đầu việc.',
    ...
    'ThÃªm Ä‘º§u viá»‡c triá»ƒn khai' => 'Thêm đầu việc triển khai',
    'Ä Ã£ thÃªm Ä‘º§u viá»‡c triá»ƒn khai.' => 'Đã thêm đầu việc triển khai.',
    'Ä º§u viá»‡c Ä‘ang bá»‹ khÃ³a, khÃ´ng thá»ƒ cáº­p nháº­t.' => 'Đầu việc đang bị khóa, không thể cập nhật.',
    ...
    'Cáº­p nháº­t Ä‘º§u viá»‡c triá»ƒn khai' => 'Cập nhật đầu việc triển khai',
    'Ä º§u viá»‡c cá»§a báº¡n Ä‘Ã£ Ä‘Æ°á»£c cáº­p nháº­t.' => 'Đầu việc của bạn đã được cập nhật.',
    'Ä Ã£ cáº­p nháº­t Ä‘º§u viá»‡c triá»ƒn khai.' => 'Đã cập nhật đầu việc triển khai.',
    'Ä º§u viá»‡c Ä‘ang bá»‹ khÃ³a, khÃ´ng thá»ƒ cáº­p nháº­t tráº¡ng thÃ¡i.' => 'Đầu việc đang bị khóa, không thể cập nhật trạng thái.',
    'Cáº­p nháº­t tráº¡ng thÃ¡i Ä‘º§u viá»‡c' => 'Cập nhật trạng thái đầu việc',
    'Tráº¡ng thÃ¡i Ä‘º§u viá»‡c Ä‘Ã£ Ä‘á»•i sang' => 'Trạng thái đầu việc đã đổi sang',
    'Ä Ã£ cáº­p nháº­t tráº¡ng thÃ¡i Ä‘º§u viá»‡c.' => 'Đã cập nhật trạng thái đầu việc.',
    'Dá»± Ã¡n Ä‘ang bá»‹ khÃ³a, khÃ´ng thá»ƒ thay Ä‘á»•i tráº¡ng thÃ¡i khÃ³a Ä‘º§u viá»‡c.' => 'Dự án đang bị khóa, không thể thay đổi trạng thái khóa đầu việc.',
    'Thay Ä‘á»•i khÃ³a Ä‘º§u viá»‡c' => 'Thay đổi khóa đầu việc',
    'Ä Ã£ khÃ³a Ä‘º§u viá»‡c.' => 'Đã khóa đầu việc.',
    'Ä Ã£ má»Ÿ khÃ³a Ä‘º§u viá»‡c.' => 'Đã mở khóa đầu việc.',
    'Ä º§u viá»‡c Ä‘ang bá»‹ khÃ³a, khÃ´ng thá»ƒ xÃ³a.' => 'Đầu việc đang bị khóa, không thể xóa.',
    'XÃ³a Ä‘º§u viá»‡c triá»ƒn khai' => 'Xóa đầu việc triển khai',
    'Ä Ã£ xÃ³a Ä‘º§u viá»‡c triá»ƒn khai.' => 'Đã xóa đầu việc triển khai.',
    ...
    'Ä º§u viá»‡c Ä‘ang bá»‹ khÃ³a, khÃ´ng thá»ƒ táº£i tá»‡p Ä‘Ã­nh kÃ¨m.' => 'Đầu việc đang bị khóa, không thể tải tệp đính kèm.',
    'Ä áº§u' => 'đầu',
    'Ä‘áº§u' => 'đầu',
    'Ã„â€˜Ã¡ÂºÂ§u' => 'đầu',
    'viá»‡c' => 'việc',
    ...
    'tÃ¡ÂºÂ£i' => 'tải',
    'tÃ¡Â»â€¡p' => 'tệp',
    'Ã„â€˜ÃƒÂ­nh kÃƒÂ¨m' => 'đính kèm',
    'lÃƒÂªn' => 'lên',
    'dÃ¡Â»Â± ÃƒÂ¡n.' => 'dự án.',
    'Ã„â€˜Ã¡ÂºÂ§u viÃ¡Â»â€¡c.' => 'đầu việc.',
    'Vui lÃƒÂ²ng nhÃ¡ÂºÂ­p' => 'Vui lòng nhập',
    'nÃ¡Â»â„¢i dung' => 'nội dung',
    'bÃƒÂ¬nh luÃ¡ÂºÂ­n.' => 'bình luận.',
    'gÃ¡Â»Â­i' => 'gửi',
    'cho' => 'cho',
    'bÃƒÂ¬nh luÃ¡ÂºÂ­n' => 'bình luận',
    'Ã„â€˜Ã¡ÂºÂ§u viÃ¡Â»â€¡c' => 'đầu việc',
    ...
    'nÃƒÂ y?' => 'này?',
    'BÃ¡ÂºÂ¡n cÃƒÂ³ chÃ¡ÂºÂ¯c muÃ¡Â»â€˜n' => 'Bạn có chắc muốn',
    'ThÃ¡ÂºÂ£o luÃ¡ÂºÂ­n' => 'Thảo luận',
    'XÃƒÂ¡c nhÃ¡ÂºÂ­n' => 'Xác nhận',
];
...
foreach ($files as $file) {
    ...
    // Also try doing a fallback decoding just in case
    // Wait! NO. I will NOT use mb_convert_encoding. I will ONLY use strtr.
