...
<head>
    ...
    <title>Thông báo dang nhap thanh cong</title>
</head>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse; background:#ffffff; border-radius:20px; overflow:hidden; box-shadow:0 10px 30px rgba(15, 23, 42, 0.08);">
                                <tr>
                                    <td style="padding:28px 32px; background:linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); color:#ffffff;">
                                        ...
                                        <div style="margin-top:8px; font-size:15px; opacity:0.92;">Hệ thống da ghi nhan mot phien dang nhap hop le vao tài khoản cua ban.</div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:28px 32px 12px;">
                                        ...
                                        <p style="margin:0; font-size:15px; line-height:1.7; color:#475569;">
                                            Day la email thông báo tu <strong>{{ $appName }}</strong> de xác nhận tài khoản cua ban vua dang nhap thanh cong vao hệ thống.
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:12px 32px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:separate; border-spacing:0; background:#f8fafc; border:1px solid #e2e8f0; border-radius:16px;">
                                            <tr>
                                                <td style="padding:18px 20px; border-bottom:1px solid #e2e8f0; font-size:14px; color:#64748b; width:180px;">Thời gian</td>
                                ...
                                <tr>
                                    <td style="padding:12px 32px 0;">
                                        <div style="padding:16px 18px; background:#fff7ed; border:1px solid #fdba74; border-radius:14px;">
                                            <div style="font-size:15px; font-weight:700; color:#9a3412; margin-bottom:8px;">Canh bao bảo mật</div>
                                            <div style="font-size:14px; line-height:1.7; color:#7c2d12;">
                                                Neu day không phai la ban, hay doi mật khẩu ngay, kiem tra cac phien dang nhap bat thuong va lien he quan tri hệ thống de duoc ho tro.
                                            </div>
                                        </div>
                                    </td>
                                </tr>
